            ...
            <header id="page-topbar">
                <div className="navbar-header">
                    <div className="d-flex">
                        ...
                        <div className="d-block pt-3 d-inline-block">
                ...
                <div data-simplebar className="h-100">
                    <div id="sidebar-menu">
                        <ul className="metismenu list-unstyled" id="side-menu">
                            ...
                            <li
                                className={
                                    isActive("/admin/wallet") ? "mm-active" : ""
                                }
                            >
                                <Link
                                    href="/admin/wallet"
                            ...
                            <li
                                className={
                                    isActive("/admin/send-information")
                                        ? "mm-active"
                                        : ""
                                }
                            >
