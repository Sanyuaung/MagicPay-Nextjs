  ...
  const load = async () => {
    try {
      ...
      const res = await apiGet<{
        data: { items: UserItem[]; pagination: PaginationState };
              ...
              <div className="column-visibility-wrap">
                ...
                {showColumnMenu ? (
                  <div className="dropdown-menu show column-visibility-menu">
                    ...
                    {renderColumnToggleItem("Login at", "loginAt")}
              ...
              >
                <thead>
                  <tr>
                    ...
                    {visibleColumns.loginAt ? (
                      <th>{renderSortHeader("Login at", "login_at")}</th>
                    ) : null}
