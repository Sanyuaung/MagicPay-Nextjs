...
export default function WalletPage() {
  ...
  return (
    <AdminShell title="Wallets" breadcrumb="Wallets" titleIconClass="ti-wallet">
      <div className="d-block mb-3">
        <div className="admin-wallet-action-wrap">
          <Link
            ...
            title="Add Amount"
          >
            <i className="typcn typcn-plus" /> Add amount to wallet account
          </Link>
          <Link
            ...
            title="Reduce Amount"
          >
            <i className="typcn typcn-minus" /> Reduce amount from wallet
            account
          </Link>
        </div>
      </div>
              ...
              <div className="column-visibility-wrap">
                ...
                {showColumnMenu ? (
                  <div className="dropdown-menu show column-visibility-menu">
                    {renderColumnToggleItem("Account Number", "accountNumber")}
                    {renderColumnToggleItem("Account Person", "accountPerson")}
                    {renderColumnToggleItem("Amount (MMK)", "amount")}
                ...
                <thead>
                  <tr>
                    {visibleColumns.accountNumber ? (
                      <th>
                        {renderSortHeader("Account Number", "account_number")}
                      </th>
                    ) : null}
                    {visibleColumns.accountPerson ? (
                      <th>
                        {renderSortHeader("Account Person", "account_person")}
                      </th>
                    ) : null}
                    {visibleColumns.amount ? (
                      <th>{renderSortHeader("Amount (MMK)", "amount")}</th>
                    ) : null}
