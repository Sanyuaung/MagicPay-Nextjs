...
export default function WalletReduceAmountPage() {
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await apiPost("/api/admin/wallets/reduce-amount", {
        user_id: userId,
        amount,
        description,
      });
      router.push(
        withAdminToast("/admin/wallet", "Wallet amount reduced successfully."),
      );
    } catch (err) {
      setMessage(err instanceof Error ? err.message : "Reduce amount failed");
    }
  };
