...
export default function HomePage() {
  ...
  return (
    <MobileShell title="Home" notifications={profile?.unReadNotifications || 0}>
        ...
        <div className="row justify-content-center">
          ...
          <div className="col-6 mt-3">
            <Link href="/receive-qr" className="home-link-card">
              <div className="card bg-theme text-white quick-card">
                <div className="card-body p-3 d-flex align-items-center">
                  <i className="scan mdi mdi-qrcode" /> <span>Receive QR</span>
                </div>
              </div>
            </Link>
          </div>
          <div className="col-12">
            <div className="card mb-3 bg-theme text-white action-list-card">
              <div className="card-body">
                ...
                >
                  <span>
                    <i className="action-icon mdi mdi-transfer" /> Transfer
                  </span>
                  <span className="mr-2">
